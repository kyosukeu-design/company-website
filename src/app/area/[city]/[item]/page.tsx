...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!city || !item) return {};
  const pageUrl = `${BASE_URL}/area/${city.slug}/${item.slug}`;
  return {
...
export default async function CityItemPage({ params }: Props) {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 4, name: item.name,   item: `${BASE_URL}/area/${city.slug}/${item.slug}` },
    ],
  };
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-12">
              ...
              <div className="mb-14">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-px bg-gray-200">
                  {[
                    ...
                    { step: "02", label: "現地確認・見積", desc: "担当者が品目・量・頻度を確認し、お見積りをご提出します。" },
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-px bg-gray-200">
                  {otherItems.map((other) => (
                    <Link
                      key={other.slug}
                      href={`/area/${city.slug}/${other.slug}`}
            ...
            <aside className="space-y-8">
              ...
              <div className="bg-gray-900 p-6 border-t-4 border-green-700">
                ...
                <p className="text-gray-400 text-xs leading-relaxed mb-5">まずはお気軽にご連絡ください。</p>
